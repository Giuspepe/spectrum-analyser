...
class LedStripe(threading.Thread):
    ...
    def refreshStripe(self):
        for column in range(0, num_columns):
            for neglevel in range(0, num_rows - spectrum_levels[column]):
...
class FFT(threading.Thread):
    def __init__(self):
        ...
        self.chunk_size = 4096  # Use a multiple of 8 (FFT will compute faster with a multiple of 8)
        ...
        self.max_value_transformed_fft_data = 60
...
# Return power array index corresponding to a particular frequency
    ...
    def run(self):
        ...
        spectrum_levels = list(map(int, spectrum_levels))
